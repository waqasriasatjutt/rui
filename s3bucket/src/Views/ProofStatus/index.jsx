...
import { create_proof_status, get_proof_status } from "../../redux/ordersSlice";

const ProofStatusList = () => {
  const { proofStatus, isLoading} = useSelector((state) => state.orders);
...
export default ProofStatusList;
